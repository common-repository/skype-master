...
if ( is_admin() )
add_menu_page( 'Talk Master', 'Talk Master', 'manage_options', 'skype-master', 'skype_master_admin', plugins_url( 'skype-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('skype_master_admin_table_header')){
	require_once( WP_PLUGIN_DIR . '/skype-master/includes/skype-master-admin-table-header.php');
}
...
if(!class_exists('skype_master_admin_table_news')){
	require_once( WP_PLUGIN_DIR . '/skype-master/includes/skype-master-admin-table-news.php');
}
//Prepare Table of elements
